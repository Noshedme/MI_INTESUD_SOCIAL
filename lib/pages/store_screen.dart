...
// Importaciones actualizadas según tu estructura real
import 'package:mi_intesud_social/pages/profile_screen.dart';
// Nota: Si usas login_page.dart como inicio, cámbialo aquí
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                _categories(),
                _productList(),
                const SizedBox(height: 100) // Espacio para el nav
              ],
            ),
          ),
          _bottomNav()
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  // Corregido: Según tu imagen el archivo es logo.png (minúscula)
                  Image.asset(
                    "assets/Logo_app.png", 
                    height: 60, 
                    errorBuilder: (context, error, stackTrace) => const Icon(Icons.store, color: Colors.white, size: 50)
                  ),
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          bool active = categories[index] == selectedCategory;
          ...
          children: [
            ...
            _navItem(Icons.person, "Perfil", false, () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const ProfileScreen(username: 'María López')),
              );
            }),
          ],
        ),
