...
class _GuestHomePageState extends State<GuestHomePage> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _pages = [
      _buildHomeContent(),
      const GuestStorePage(),
      const EventosScreen(),
      _buildLockedProfilePage(),
    ];
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Regístrate AHORA y obtén 20% DE DESCUENTO en tu matrícula. ¡Oferta por tiempo limitado!",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "Aquí puedes ver publicaciones de nuestras carreras, eventos institucionales e información de marketing.",
  ...
  Widget _buildSoftwarePost() {
    return _baseCard(
      ...
      content:
          "💻 Aprende las tecnologías más demandadas del mercado: React, Node.js, Python, y más. Nuestros laboratorios cuentan con equipamiento de última generación. ¡Ven a visitarnos!",
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "¡No olvides tu 20% de descuento especial!",
            style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 13,
  ...
  Widget _buildOfficialPost() {
    return _baseCard(
      ...
      content:
          "🎓 ¡MATRÍCULA ABIERTA 2026! Aprovecha nuestro 20% de descuento en todas las carreras. Forma parte de la mejor institución educativa del sur. ¡No te quedes sin tu cupo!",
      avatarImage: "assets/images/intesudoficial.webp",
    );
  }

  Widget _buildLockedProfilePage() {
    return Column(
      children: [
        _buildGuestHeader(),
        Expanded(
              ...
              child: Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      "Debes registrarte o iniciar sesión para acceder a tu perfil.",
                      textAlign: TextAlign.center,
                    ),
                  ],
                ),
