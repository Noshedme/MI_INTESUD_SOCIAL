...
// Nota: Si no tienes home_screen.dart, cámbialo por el nombre correcto (ej. login_page.dart)
// Por ahora lo comentaré para que no te de error si el archivo no existe
// import 'package:mi_intesud_social/pages/home_screen.dart'; 

class ProfileScreen extends StatelessWidget {
  final String username; // Agregado correctamente como propiedad de la clase
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildContent(),
                const SizedBox(height: 100), // Espacio para que el nav no tape el contenido
              ],
            ),
          ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            username, // Usando la variable dinámica
    ...
    return _cardContainer(
      const Column(
        ...
        children: [
          ...
          SizedBox(height: 15),
          _InfoRow(Icons.email, "usuario@intesud.edu"),
          _InfoRow(Icons.phone, "+593 99 123 4567"),
          _InfoRow(Icons.location_on, "Quito, Ecuador"),
          _InfoRow(Icons.calendar_month, "Miembro desde 2024"),
        ],
      ),
    );
  }
        ...
        child: Row(
          ...
          children: [
            _navItem(Icons.home, "Inicio", false, () {
              // Ajusta esto al nombre real de tu página de inicio
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(label, style: const TextStyle(color: Color(0xFF96D9C0), fontSize: 12)),
      ],
    );
  }
}
